...
- For Band B coverage, prefer explicit meta tags such as `band:gcc13_14`, `processing_path:native_text_capture` or `processing_path:single_sink_structured`, and `fallback_contract:bounded_render` or `fallback_contract:honest_fallback`.
