...
| Config / environment contract | `gcc-formed-architecture-proposal.md`, `CONTRIBUTING.md`, `ADR-0020` | precedence, defaults, env keys, or config meaning changes for existing users | additive config is optional and preserves current precedence and defaults |
