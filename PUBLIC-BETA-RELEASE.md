...
The GitHub Release body must also link the current [SUPPORT-BOUNDARY.md](SUPPORT-BOUNDARY.md), [KNOWN-LIMITATIONS.md](KNOWN-LIMITATIONS.md), and this document, and must call out the signing key id plus trusted signing public key SHA-256 for the shipped `SHA256SUMS.sig`.
