...
`cargo xtask rc-gate` は curated replay / rollout matrix / benchmark / deterministic replay / fuzz smoke を自動実行しつつ、まだ fully automated でない RC sign-off evidence をこの directory から読み込む。
