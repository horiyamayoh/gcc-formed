...
- Preserves reason-coded fallback evidence in trace, replay, and snapshot outputs, including sink conflicts, unsupported tiers, shadow-only paths, missing SARIF, malformed SARIF, and renderer-side conservative fallback.
