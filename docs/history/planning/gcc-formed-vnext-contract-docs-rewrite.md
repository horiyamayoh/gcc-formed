...
audience: both
use_for: Historical planning context and provenance.
do_not_use_for: Current implementation decisions or active prioritization.
supersedes: []
superseded_by: []
---
> [!IMPORTANT]
> Authority: `history-only` / `legacy`
> Use for: Historical planning context and provenance.
> Do not use for: Current implementation decisions or active prioritization.
...
SupportLevel / ProcessingPath / RawPreservationLevel の正本は [SUPPORT-BOUNDARY.md](../../support/SUPPORT-BOUNDARY.md) に置く。  
README では要点だけを再掲する。
...
1. [SUPPORT-BOUNDARY.md](../../support/SUPPORT-BOUNDARY.md)  
   現在の public wording と beta support posture の正本
2. [EXECUTION-MODEL.md](../../process/EXECUTION-MODEL.md)  
   Epic を切る前提、Issue 正本主義、nightly agent 運用の正本
3. [diagnostic-ir-v1alpha-spec.md](../../specs/diagnostic-ir-v1alpha-spec.md)  
   正規化 IR の実装契約
4. [gcc-adapter-ingestion-spec.md](../../specs/gcc-adapter-ingestion-spec.md)  
   capture / ingest の実装契約
5. [rendering-ux-contract-spec.md](../../specs/rendering-ux-contract-spec.md)  
   renderer と disclosure の実装契約
6. [quality-corpus-test-gate-spec.md](../../specs/quality-corpus-test-gate-spec.md)  
   corpus-driven quality gate の実装契約
7. [adr-initial-set/README.md](../../../adr-initial-set/README.md)  
   採択済み ADR の索引
8. [VERSIONING.md](../../policies/VERSIONING.md) / [GOVERNANCE.md](../../policies/GOVERNANCE.md)  
...
- [SUPPORT-BOUNDARY.md](../../support/SUPPORT-BOUNDARY.md): public wording と support posture の正本
- [EXECUTION-MODEL.md](../../process/EXECUTION-MODEL.md): delivery system の正本
- [diagnostic-ir-v1alpha-spec.md](../../specs/diagnostic-ir-v1alpha-spec.md): IR 契約
- [gcc-adapter-ingestion-spec.md](../../specs/gcc-adapter-ingestion-spec.md): capture / ingest 契約
- [rendering-ux-contract-spec.md](../../specs/rendering-ux-contract-spec.md): terminal / CI renderer 契約
- [quality-corpus-test-gate-spec.md](../../specs/quality-corpus-test-gate-spec.md): quality gate 契約
- [packaging-runtime-operations-spec.md](../../specs/packaging-runtime-operations-spec.md): packaging / install / rollback / release engineering 契約
- [implementation-bootstrap-sequence.md](../../process/implementation-bootstrap-sequence.md): 実装開始順の正本
- [adr-initial-set/README.md](../../../adr-initial-set/README.md): ADR 索引
- [VERSIONING.md](../../policies/VERSIONING.md): 成熟度ラベルと artifact semver
- [GOVERNANCE.md](../../policies/GOVERNANCE.md): 変更分類と freeze ルール
...
詳しくは [EXECUTION-MODEL.md](../../process/EXECUTION-MODEL.md) を参照。
...
個別の release / install / rollback / stable-promotion 手順は [packaging-runtime-operations-spec.md](../../specs/packaging-runtime-operations-spec.md) と関連 runbook を正本とする。
