...
audience: both
use_for: Historical GCC15-first architecture baseline and provenance.
do_not_use_for: Current architecture or implementation decisions.
supersedes: []
superseded_by:
  - ../../architecture/gcc-formed-vnext-change-design.md
  - ../../support/SUPPORT-BOUNDARY.md
  - ../../process/EXECUTION-MODEL.md
---
> [!IMPORTANT]
> Authority: `history-only` / `superseded`
> Use for: Historical GCC15-first architecture baseline and provenance.
> Do not use for: Current architecture or implementation decisions.
