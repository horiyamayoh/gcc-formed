...
audience: both
use_for: Historical delivery model provenance.
do_not_use_for: Current execution rules or current implementation sequencing.
supersedes: []
superseded_by:
...
> Use for: Historical delivery model provenance.
> Do not use for: Current execution rules or current implementation sequencing.
