...
This document is the canonical wording for the current `v1.0.0 stable` / `1.0.0` support posture. The immutable promoted payload retains semver `1.0.0-rc.1`.
...
## 2. Current `v1.0.0 stable` / `1.0.0` support boundary
...
- `repair_units_hybrid_v2` is the qualified stable default terminal preset. `subject_blocks_v2` is the immediate rollback preset; `subject_blocks_v1` and `legacy_v1` remain compatibility presets. Raw and explain remain one-operation disclosure paths.
