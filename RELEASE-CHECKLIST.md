...
- RC gate retains `replay-report.json`, `bench-smoke-report.json`, `deterministic-replay-report.json`, `rollout-matrix-report.json`, `metrics-report.json`, and the normalized manual evidence JSON files.
