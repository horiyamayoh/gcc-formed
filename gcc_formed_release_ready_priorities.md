...
`diag_cli_front/src/main.rs` は **1282 lines / 42.8 KB** あります。  
CLI parsing、backend decision、wrapper mode、trace path、self-check、introspection、execution orchestration がまとまっているため、**最も変更頻度の高い層が一箇所に集まりすぎています**。
