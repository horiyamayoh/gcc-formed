...
4. **public beta release path、RC gate automation、RC metrics packet、fuzz / adversarial hardening、human evaluation kit は 2026-04-09 時点で `main` に反映済みで、次の user-visible priority は compatibility path の honest UX 固定である**
