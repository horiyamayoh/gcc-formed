...
4. **public beta release path は 2026-04-09 時点で `main` に反映済みで、次の user-visible priority は `1.0.0-rc.N` 判定のための RC gate automation と evaluation evidence の固定である**
