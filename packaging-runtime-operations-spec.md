...
- artifact の種類・命名・内容
- target triple / libc / arch ごとの support tier
...
- target triple / arch / libc / support tier
...
## 8. Target / support tier policy

### 8.1 artifact support matrix

| Tier | target triple | artifact status | 主用途 | 備考 |
|---|---|---|---|---|
...
4. exception artifact を support tier とともに明示できる
...
- support tier で定義された host 上で install/rollback できること
