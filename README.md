...
- GCC 15 representative corpus に対する acceptance report と snapshot report を `cargo xtask replay --report-dir ...` / `cargo xtask snapshot --report-dir ...` で保存でき、replay report は reason-coded fallback 件数も集計する
