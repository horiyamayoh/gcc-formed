...
- [eval/rc/README.md](eval/rc/README.md): RC gate が ingest する issue budget / fuzz / UX sign-off evidence の置き場
...
- `cargo xtask rc-gate` は curated replay / rollout matrix / benchmark smoke / deterministic replay と manual RC evidence を 1 コマンドで集約し、`rc-gate-report.json` と `rc-gate-summary.md` を出力できる
...
cargo xtask rc-gate --report-dir target/rc-gate --allow-pending-manual-checks
