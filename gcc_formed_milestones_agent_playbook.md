...
- public beta release path、RC gate automation、RC metrics instrumentation、fuzz / adversarial hardening、human evaluation kit は `main` に反映済みで、次の未完了 work package は `M2-P1-1: compatibility path の honest UX を固定する` である
