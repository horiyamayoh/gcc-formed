...
- public beta release path、RC gate automation、RC metrics instrumentation、fuzz / adversarial hardening、human evaluation kit、compatibility path の honest UX、stable release automation、support / incident / rollback runbook は `main` に反映済みで、次の未完了 work package は `M3-P0-3: governance freeze をかける` である
