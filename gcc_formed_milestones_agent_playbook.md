...
- public beta release path、RC gate automation、RC metrics instrumentation、fuzz / adversarial hardening、human evaluation kit、compatibility path の honest UX は `main` に反映済みで、次の未完了 work package は `M3-P0-1: stable release automation を完成させる` である
