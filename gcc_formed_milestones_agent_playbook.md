...
- `v1beta` という成熟度ラベルと `0.2.0-beta.N` 系 artifact version の意味は整理済みだが、RC sign-off evidence の運用はまだ固め切れていない
...
- public beta release path は GitHub Release workflow / docs / promote story を含めて `main` に反映済みで、次の未完了 work package は `M2-P0-1: RC gate を自動化する` である
